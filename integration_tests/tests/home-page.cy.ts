...
context('Home', () => {
  ...
  it('shows the court bail referrer cards', () => {
    ...
    //  Then see the correct cards
    page.shouldShowCards(['applications', 'new-application-new-cohorts'])
  ...
  it('shows the prison bail referrer cards', () => {
    ...
    //  Then see the correct cards
    page.shouldShowCards(['applications', 'new-application-new-cohorts', 'prison-applications'])
  ...
  it('shows the assessor cards', () => {
    ...
    //  Then I see no cards
    page.shouldNotShowCards(['applications', 'new-application-new-cohorts'])
