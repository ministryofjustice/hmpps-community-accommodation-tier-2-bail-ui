...
describe('applicationsController', () => {
  ...
  describe('selectApplicationOrigin', () => {
    it('redirects to the new cohorts select application type page when application origin is not selected', async () => {
      request.body = {
        applicationOrigin: null,
      }
      ...
      expect(response.redirect).toHaveBeenCalledWith(paths.applications.newCohorts.applicationOrigin({}))
    })
    ...
    it('redirects to the bail before-you-start page when application origin is bail', async () => {
      ...
      expect(response.redirect).toHaveBeenCalledWith(paths.applications.newCohorts.bail.beforeYouStart({}))
    })
    ...
    it('redirects to the new cohorts before-you-start page when application origin is other', async () => {
      ...
      expect(response.redirect).toHaveBeenCalledWith(paths.applications.newCohorts.beforeYouStart({}))
    })

    it('redirects back to the application origin view with an error when no origin is selected', async () => {
      request.body = {
        applicationOrigin: '',
      }
  ...
  describe('selectBailApplicationOrigin', () => {
    beforeEach(() => {
      response = createMock<Response>({
