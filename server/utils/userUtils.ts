...
export const sections = {
  ...
  submittedApplications: {
    ...
    description: '<p>View all CAS2 for bail submitted applications</p>',
  ...
  managementInformationReports: {
    ...
    description: '<p>View all CAS2 bail management information reports to download</p>',
  ...
  prisonApplications: {
    ...
    description: 'View all recently submitted CAS2 prison bail applications',
