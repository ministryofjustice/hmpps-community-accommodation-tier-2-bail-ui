  ...
  describe('errors', () => {
    describe('when top-level questions are unanswered', () => {
      ...
      it('includes a validation error for _needsSupport_', () => {
        expect(page.errors()).toHaveProperty('needsSupport', 'Select yes if they need any support')
      })

      it('includes a validation error for _receivesTreatment_', () => {
        expect(page.errors()).toHaveProperty('receivesTreatment', 'Select yes if they receive any treatment')
      })
