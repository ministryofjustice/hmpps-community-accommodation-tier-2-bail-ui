  ...
  describe('initialize', () => {
    describe('when oasys sections are returned', () => {
      it('instantiates the class with the task data in the correct format', async () => {
        ...
        oasys.analysisSuicideSelfharm = 'current and previous risk answer'
        ...
        const taskData = {
          'risk-to-self': {
            ...
            'oasys-import': {
              ...
              oasysStartedDate: oasys.metadata.dateStarted,
              oasysCompletedDate: oasys.metadata.dateCompleted,
            },
          },
        }
