...
describe('Summary', () => {
  ...
  const applicationWithSummaryData = applicationFactory.build({
    person,
    data: { 'risks-of-serious-harm-to-others': { 'summary-data': roshSummaryData } },
  })

  const applicationWithManualRoSHSummaryData = applicationFactory.build({
    person,
    data: { 'risks-of-serious-harm-to-others': { 'manual-rosh-information': manualRoSHSummaryData } },
  })
        ...
        it('sets the risks to undefined', () => {
          ...
          const page = new Summary(
            {},
            {
              ...
              data: { 'risks-of-serious-harm-to-others': { 'summary-data': roshSummaryDataWithoutValue } },
            },
          )
