...
import { Cas2v2Application } from '../../@types/shared'
...
describe('utils', () => {
  ...
  describe('getBody', () => {
    it('if there is userInput it returns it', () => {
      ...
      expect(utils.getBody({} as TaskListPageInterface, {} as Cas2v2Application, {} as Request, input)).toEqual(input)
    })

    it('if there isnt userInput and there is a request body the request body is returned', () => {
      const request: DeepMocked<Request> = createMock<Request>()

      expect(utils.getBody({} as TaskListPageInterface, {} as Cas2v2Application, request, {}))
    })
